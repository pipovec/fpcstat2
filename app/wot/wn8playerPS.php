 ...
 * Upravene tak, aby nemusel pristupovat zakazdym pri volani triedy do databazy. Ale musi sa mu pridat etv_tabulka pomocov setra.
 *  
 * @author pipovec
 */
...
class wn8playerPS {
  ...
  public  $etv_table;
    ...
    function SetETVtable($etv_table)
    {
        $this->etv_table = $etv_table;
    }
